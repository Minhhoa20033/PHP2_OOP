    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-white">
            <a class="navbar-brand order-1" href="index.html">
                <img class="img-fluid" width="100px" src="assets/client/images/logo.png" alt="Reader | Hugo Personal Blog Template">
            </a>
                        ...
                        <nav>
                            @if (isset($_SESSION['user']))
                                @if ($_SESSION['user']['type'] == 'admin')
                                    <a class="btn btn-primary" href="{{ url('admin/users') }}">Admin</a>
                                @endif
